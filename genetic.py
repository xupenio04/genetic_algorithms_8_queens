...
plt.axhline(mean_val + std_val, color='purple', linestyle=':', label='Desvio Padrão')
plt.axhline(mean_val - std_val, color='purple', linestyle=':')
...
plt.axhline(np.mean(fit_mean) + np.std(fit_mean), color='purple', linestyle=':', label='Desvio Padrão')
plt.axhline(np.mean(fit_mean) - np.std(fit_mean), color='purple', linestyle=':')
